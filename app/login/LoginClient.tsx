...
export default function LoginClient() {
  ...
  // ✅ IMPORTANT: default next is billing (pay-first)
  ...
  return (
    <main
      style={{
        ...
        color: "white",
        background:
          "radial-gradient(1200px 600px at 20% 0%, rgba(255,255,255,0.18), transparent 60%), linear-gradient(135deg, rgb(17,24,39) 0%, rgb(0,0,0) 45%, rgb(17,24,39) 100%)",
        fontFamily:
