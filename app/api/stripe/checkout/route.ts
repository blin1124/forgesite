...
export default function BillingClient() {
  ...
  async function goCheckout() {
    ...
    try {
      ...
      // ✅ IMPORTANT: call the route that actually exists in your repo
      ...
      try {
        ...
        throw new Error(`Checkout response not JSON (${res.status}). ${text.slice(0, 250)}`);
      }
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 16, flexWrap: "wrap" }}>
          ...
          <button onClick={() => router.push("/terms")} style={secondaryBtn}>Terms</button>
          <button onClick={() => router.push("/privacy")} style={secondaryBtn}>Privacy</button>
